#ifndef INSERTKVPAIR_H
#define INSERTKVPAIR_H
...
public:
     ...
     */
    void randomInsertKVPairInRandomDepth(double stopProbability = 0.6);
...
private:
     ...
     */
    void insertKVPairInEveryDepthHelper(QJsonObject &obj);
     ...
     * @param stopProbability 停止概率，当小于该概率时，直接在当前层级下插入，否则继续遍历
     */
    void randomInsertKVPairInRandomDepthHelper(QJsonObject &obj, double stopProbability = 0.6);
